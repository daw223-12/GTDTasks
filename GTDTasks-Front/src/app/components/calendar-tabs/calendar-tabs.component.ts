...
import { TicklerService } from 'src/app/services/tickler.service';import { AppointmentService } from 'src/app/services/appointment.service';
;
...
export class CalendarTabsComponent {
  ...
  constructor(private route: ActivatedRoute, private ticklerApi: AppointmentService) {}
